...
/***/ function(module, exports) {
	...
	var LearnerList = React.createClass({
	    displayName: "LearnerList",

	    render: function render() {
	        var data = this.props.data;

	        var learners = data.map(function (learner) {
	            return React.createElement(Learner, { key: learner.key, data: learner });
	        });
	...
	var Course = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "figure",
	                { className: "sessionImg fl" },
	                React.createElement("img", { src: data.logo, alt: "course" })
	            ),
	            React.createElement(
	                "div",
	                { className: "coursesDetail fr" },
	                React.createElement(
	                    "h2",
	                    { className: "title" },
	                    data.title
	                ...
	                React.createElement(
	                    "ul",
	                    { className: "sessionPrimaryDetails" },
	                    React.createElement(
	                        "li",
	                        { className: "live" },
	                        "Live Session"
	                ...
	                React.createElement(
	                    "ul",
	                    { className: "sessionSecondryDetails" },
	                    React.createElement(
	                        "li",
	                        { className: "lenth" },
	                        data.duration,
	                    ...
	                    React.createElement(LearnerList, { data: data.learners })
	                ),
	                React.createElement(
	                    "ul",
	                    { className: "sessionNotification clearfix" },
	                    React.createElement(
	                        "li",
	                        { className: "fl" },
	                        data.weeksCompleted,
	...
	var CourseList = React.createClass({
	    ...
	    onclickhandler: function onclickhandler(ev) {
	    ...
	    render: function render() {
	        ...
	        if (data && data.length > 0) {
	            var courses = data.map(function (course) {
	                return React.createElement(Course, { key: course.key, data: course });
	            });

	            return React.createElement(
	                "div",
	                { "data-tab-content": "active", className: "tabContent", onClick: this.onclickhandler },
	                courses
	            );
	        } else {
	            return React.createElement(
	                "span",
	                { className: "item notify", onClick: this.onclickhandler },
	                "no data to show..."
	            );
	        }
	    }
	...
	ReactDOM.render(React.createElement(CourseList, { data: window.var_reactOutput }), document.getElementById('tabContentWrap'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNode = typeof module !== 'undefined' && module.exports,
	    React = isNode ? __webpack_require__(3) : window.React,
	    ReactDOM = isNode ? __webpack_require__(3) : window.ReactDOM;
	...
	var ListItem = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'li',
	            { className: 'navItem', onClick: this.onclickhandler },
	            React.createElement(
	                'a',
	                { href: '#' },
	                this.props.iDetail
	...
	var NavigationList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var listItems = data.map(function (item) {
	            return React.createElement(ListItem, { iDetail: item.text });
	        });
	        return React.createElement(
	            'div',
	            { id: 'leftNav' },
	            React.createElement(
	                ...
	                React.createElement(
	                    'a',
	                    { href: '#' },
	                    React.createElement('img', { src: 'asset/image/logo.jpg', alt: 'NIIT' })
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'switchAcademy' },
	                    React.createElement(
	                        'a',
	                        { href: '#' },
	                        'Swith Academy'
	...
	if (isNode) {
	    ...
	    ReactDOM.render(React.createElement(NavigationList, { data: window.var_leftNavOutput }), document.getElementById('leftNavContainer'));
	}
