                                    ...
                                    <ul className="accordionWrapper">
                                                    ...
                                                    <table className="tableGrid">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td className="table-col-2 video"><span>Section</span></td>
                                                                <td className="table-col-3">AED and CPR Training</td>
                                                            </tr>
                                                            <tr>
                                                                <td className="table-col-1">11 Mar</td>
                                                                <td className="table-col-2 video"><span>Section</span></td>
                                                                <td className="table-col-3">What Is a Defibrillator How Does It Work</td>
                                                            </tr>
                                                            <tr>
                                                                <td className="table-col-1">11 Mar</td>
                                                                <td className="table-col-2 doc"><span>Section</span></td>
                                                                <td className="table-col-3">Defibrillation</td>
                                                            </tr>
                                                            <tr>
                                                                <td className="table-col-1">12 Mar</td>
                                                                <td className="table-col-2 doc"><span>Section</span></td>
                                                                <td className="table-col-3">Defibrillation</td>
                                                            </tr>
                                                            <tr>
                                        ...
                                        <li className="clearfix">
                                            ...
                                            <div className="accordionContent">
                                                <div className="col-1 inLineDatePicker" data-date-start="03/05/2016" data-date-end="03/10/2016"></div>
                                                <div className="col-2">
                                                    <table className="tableGrid">
                                                        <tbody>
                                                            <tr>
                                        ...
                                        <li className="clearfix">
                                            ...
                                            <div className="accordionContent">
                                                <div className="col-1 inLineDatePicker" data-date-start="09/10/2016" data-date-end="09/20/2016"></div>
                                                <div className="col-2">
                                                    <table className="tableGrid">
                                                        <tbody>
                                                            <tr>
